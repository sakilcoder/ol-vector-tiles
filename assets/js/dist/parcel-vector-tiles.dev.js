...
function updateParcelVectorTile() {
  parcelVectorTile.setStyle(style_simple); // ----------priceRange----------
  ...
  var sdate = new Date('1971/01/01').setHours(0, 0, 0, 0);
  var edate = new Date().setHours(0, 0, 0, 0);
  ...
  if (shapestare_minValue) {
    parcelVectorTile.setStyle(function (feature) {
      return filterByShapestare(feature, {
        condition: shapestare_condition,
        minValue: parseInt(shapestare_minValue),
        maxValue: parseInt(shapestare_maxValue)
      });
    });
  } // ----------Rectangularity----------
  ...
  if (minValue_lot_depth) {
    parcelVectorTile.setStyle(function (feature) {
      return filterByLotDepth(feature, {
        condition: condition_lot_depth,
        minValue: parseFloat(minValue_lot_depth),
        maxValue: parseFloat(maxValue_lot_depth)
      });
    });
  } // ----------Lot Width------------
  ...
  if (minValue_lot_width) {
    parcelVectorTile.setStyle(function (feature) {
      return filterByLotWidth(feature, {
        condition: condition_lot_width,
        minValue: parseFloat(minValue_lot_width),
        maxValue: parseFloat(maxValue_lot_width)
      });
    });
  } // ---------------Lot Type---------------
  ...
  var sLastSaleDate = new Date('1971/01/01').setHours(0, 0, 0, 0);
  var eLastSaleDate = new Date().setHours(0, 0, 0, 0);
  ...
  if (sLastSaleDate > eLastSaleDate) {
    var _tdate = sLastSaleDate;
    sLastSaleDate = eLastSaleDate;
    eLastSaleDate = _tdate;
  }
  ...
  if (minValue_last_sale_amount) {
    parcelVectorTile.setStyle(function (feature) {
      return filterBylast_sale_amount(feature, {
        condition: condition_last_sale_amount,
        minValue: parseFloat(minValue_last_sale_amount),
        maxValue: parseFloat(maxValue_last_sale_amount)
      });
    });
  } //----------- Sale Two Date------------
  ...
  var sSaleTwoDate = new Date('1971/01/01').setHours(0, 0, 0, 0);
  var eSaleTwoDate = new Date().setHours(0, 0, 0, 0);
  ...
  if (sSaleTwoDate > eSaleTwoDate) {
    var _tdate2 = sSaleTwoDate;
    sSaleTwoDate = eSaleTwoDate;
    eSaleTwoDate = _tdate2;
  }
  ...
  if (minValue_sale_two_amount) {
    parcelVectorTile.setStyle(function (feature) {
      return filterBysale_two_amount(feature, {
        condition: condition_sale_two_amount,
        minValue: parseFloat(minValue_sale_two_amount),
        maxValue: parseFloat(maxValue_sale_two_amount)
      });
    });
